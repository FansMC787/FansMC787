<div align="center">
  <img src="assets/profile-banner.svg" alt="Daniel Thavarajan Banner" width="100%" max-width="1100px">
</div>
...
<table width="100%">
  <tr>
    <td width="50%" valign="top">
      <strong>Core Languages & Gaming</strong><br>
      • <code>C#</code> (Unity / Core Development)<br>
      • <code>JavaScript</code> (Interaktive Logik)
    </td>
    <td width="50%" valign="top">
      <strong>Web Development</strong><br>
      • <code>HTML5</code> & <code>CSS3</code> (Modernes UI/UX)<br>
...
<div align="center">
  <sub>Interessiert an Code? Schau dich gerne in meinen Repositories um! ⚡ Erzeugt mit automatisierten GitHub Actions.</sub>
</div>